...
export default function Investment() {
  return (
    <section
      ...
      className="relative h-[54rem] overflow-hidden p-24"
    >
      ...
      <div className="flex">
        <div className="font-inter basis-1/2">
          ...
          <h3 className="mb-2 bg-gradient-to-r from-[#328AE2] to-[#FF0D39] bg-clip-text text-[2rem] leading-[2.4rem] font-bold tracking-[-0.08rem] text-transparent">
            Ami&M là đối tác tư vấn - đầu tư bền vững, phát triển dịch vụ cao
            cấp và nâng tầm giáo dục trải nghiệm.
          </h3>
          <p className="text-lg font-medium tracking-tight text-[#333]">
