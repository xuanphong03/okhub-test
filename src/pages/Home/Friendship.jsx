...
export default function Friendship() {
  return (
    ...
    >
      ...
      <img
        src={VectorTeamwork1}
        className="pointer-events-none absolute right-0 bottom-0 left-0 z-[2] hidden h-fit w-full translate-y-[3rem] object-cover lg:inline-block xl:translate-y-[4rem] 2xl:translate-y-[5.25rem]"
      />
      <img
        src={VectorTeamwork2}
        className="pointer-events-none absolute right-0 bottom-0 left-0 z-[2] hidden h-fit w-full translate-y-[4.25rem] object-cover lg:inline-block xl:translate-y-[5.25rem] 2xl:translate-y-[6.5rem]"
      />
      <img
        alt="Teamwork"
